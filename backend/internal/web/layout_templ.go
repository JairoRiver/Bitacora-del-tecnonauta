...
func Layout(title string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, " — Bitácora Admin</title><script src=\"https://cdn.tailwindcss.com\"></script></head><body class=\"bg-gray-100 text-gray-900 min-h-screen\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func Nav(username string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "</span><form method=\"POST\" action=\"/admin/logout\"><button type=\"submit\" class=\"border border-indigo-300 text-indigo-300 text-sm px-3 py-1 rounded hover:bg-indigo-300 hover:text-indigo-900 cursor-pointer\">Salir</button></form></div></nav>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
